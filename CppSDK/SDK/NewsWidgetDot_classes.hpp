...
public:
	...
	TMulticastInlineDelegate<void(int32 Index)>   DotClicked;                                        // 0x0398(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
