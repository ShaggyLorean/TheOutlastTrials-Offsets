...
// Function BrightnessCalibrationMenu.BrightnessCalibrationMenu_C.OnMouseButtonDown
// 0x03B0 (0x03B0 - 0x0000)
struct BrightnessCalibrationMenu_C_OnMouseButtonDown final
{
public:
	struct FGeometry                              MyGeometry;                                        // 0x0000(0x0038)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
...
static_assert(alignof(BrightnessCalibrationMenu_C_OnMouseButtonDown) == 0x000008, "Wrong alignment on BrightnessCalibrationMenu_C_OnMouseButtonDown");
static_assert(sizeof(BrightnessCalibrationMenu_C_OnMouseButtonDown) == 0x0003B0, "Wrong size on BrightnessCalibrationMenu_C_OnMouseButtonDown");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, MyGeometry) == 0x000000, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::MyGeometry' has a wrong offset!");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, MouseEvent) == 0x000038, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::MouseEvent' has a wrong offset!");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, ReturnValue) == 0x0000A8, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::ReturnValue' has a wrong offset!");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, Temp_bool_Variable) == 0x000160, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, CallFunc_PointerEvent_GetEffectingButton_ReturnValue) == 0x000168, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::CallFunc_PointerEvent_GetEffectingButton_ReturnValue' has a wrong offset!");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, CallFunc_Handled_ReturnValue) == 0x000180, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::CallFunc_Handled_ReturnValue' has a wrong offset!");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, CallFunc_EqualEqual_KeyKey_ReturnValue) == 0x000238, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::CallFunc_EqualEqual_KeyKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, CallFunc_Unhandled_ReturnValue) == 0x000240, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::CallFunc_Unhandled_ReturnValue' has a wrong offset!");
static_assert(offsetof(BrightnessCalibrationMenu_C_OnMouseButtonDown, K2Node_Select_Default) == 0x0002F8, "Member 'BrightnessCalibrationMenu_C_OnMouseButtonDown::K2Node_Select_Default' has a wrong offset!");
