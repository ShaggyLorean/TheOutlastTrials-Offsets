...
struct FEventReply UOptionsMenu_C::OnMouseButtonDown(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("OptionsMenu_C", "OnMouseButtonDown");

	Params::OptionsMenu_C_OnMouseButtonDown Parms{};
