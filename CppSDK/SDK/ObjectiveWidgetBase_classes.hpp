...
public:
	...
	TMulticastInlineDelegate<void(bool IsVisible)> VisibilityEventDispatcher;                         // 0x0318(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
