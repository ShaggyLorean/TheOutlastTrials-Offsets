...
// Function OptionsMenu.OptionsMenu_C.OnMouseButtonDown
// 0x03B0 (0x03B0 - 0x0000)
struct OptionsMenu_C_OnMouseButtonDown final
{
public:
...
static_assert(alignof(OptionsMenu_C_OnMouseButtonDown) == 0x000008, "Wrong alignment on OptionsMenu_C_OnMouseButtonDown");
static_assert(sizeof(OptionsMenu_C_OnMouseButtonDown) == 0x0003B0, "Wrong size on OptionsMenu_C_OnMouseButtonDown");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, MyGeometry) == 0x000000, "Member 'OptionsMenu_C_OnMouseButtonDown::MyGeometry' has a wrong offset!");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, MouseEvent) == 0x000038, "Member 'OptionsMenu_C_OnMouseButtonDown::MouseEvent' has a wrong offset!");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, ReturnValue) == 0x0000A8, "Member 'OptionsMenu_C_OnMouseButtonDown::ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, Temp_bool_Variable) == 0x000160, "Member 'OptionsMenu_C_OnMouseButtonDown::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, CallFunc_PointerEvent_GetEffectingButton_ReturnValue) == 0x000168, "Member 'OptionsMenu_C_OnMouseButtonDown::CallFunc_PointerEvent_GetEffectingButton_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, CallFunc_Handled_ReturnValue) == 0x000180, "Member 'OptionsMenu_C_OnMouseButtonDown::CallFunc_Handled_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, CallFunc_EqualEqual_KeyKey_ReturnValue) == 0x000238, "Member 'OptionsMenu_C_OnMouseButtonDown::CallFunc_EqualEqual_KeyKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, CallFunc_Unhandled_ReturnValue) == 0x000240, "Member 'OptionsMenu_C_OnMouseButtonDown::CallFunc_Unhandled_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenu_C_OnMouseButtonDown, K2Node_Select_Default) == 0x0002F8, "Member 'OptionsMenu_C_OnMouseButtonDown::K2Node_Select_Default' has a wrong offset!");
