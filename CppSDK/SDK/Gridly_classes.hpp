...
{
public:
	TMulticastInlineDelegate<void(TArray<struct FPolyglotTextData>& PolyglotTextDatas, TArray<struct FGridlyTableRow>& TableRows, float progress, struct FGridlyResult& Error)> OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(TArray<struct FPolyglotTextData>& PolyglotTextDatas, TArray<struct FGridlyTableRow>& TableRows, float progress, struct FGridlyResult& Error)> OnProgress;                                        // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(TArray<struct FPolyglotTextData>& PolyglotTextDatas, TArray<struct FGridlyTableRow>& TableRows, float progress, struct FGridlyResult& Error)> OnFail;                                            // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	TMulticastInlineDelegate<void(TArray<struct FGridlyTableRow>& GridlyTableRows, float progress, struct FGridlyResult& Error)> OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(TArray<struct FGridlyTableRow>& GridlyTableRows, float progress, struct FGridlyResult& Error)> OnProgress;                                        // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(TArray<struct FGridlyTableRow>& GridlyTableRows, float progress, struct FGridlyResult& Error)> OnFail;                                            // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
