...
public:
	...
	class UStaticMeshComponent*                   ScapegoatDevice_Needle_01;                         // 0x0C78(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(AHacking_SkillController_BP_C, ScapegoatDevice_Needle_01) == 0x000C78, "Member 'AHacking_SkillController_BP_C::ScapegoatDevice_Needle_01' has a wrong offset!");
