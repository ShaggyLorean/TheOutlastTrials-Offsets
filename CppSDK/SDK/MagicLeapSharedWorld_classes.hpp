...
public:
	...
	TMulticastInlineDelegate<void()>              OnNewLocalDataFromClients;                         // 0x0328(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
