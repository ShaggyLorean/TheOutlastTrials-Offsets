...
public:
	...
	TMulticastInlineDelegate<void(const struct FRewardUIData& reward, class USelectableRewardWidget_C* Widget)> OnHovered;                                         // 0x02B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(const struct FRewardUIData& reward, class USelectableRewardWidget_C* Widget)> OnUnhovered;                                       // 0x02C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
