...
public:
	...
	TMulticastInlineDelegate<void(class UTextChatEntry_C* Entry)> OnHidden;                                          // 0x02E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
